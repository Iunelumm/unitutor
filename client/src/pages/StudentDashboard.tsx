...
import { BookOpen, Calendar, Search, User, HelpCircle, LogOut, Heart, FileText } from "lucide-react";
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          ...
          <Link href="/student/my-tutors">
            <Card className="hover:shadow-md transition-shadow cursor-pointer">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">Your favorite tutors</p>
              </CardContent>
            </Card>
          </Link>
          ...
          <Link href="/student/files">
            <Card className="hover:shadow-md transition-shadow cursor-pointer">
              <CardHeader>
                ...
                <CardTitle className="text-lg">Files & Notes</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground">All your materials</p>
              </CardContent>
            </Card>
          </Link>
